...
do
    mkdir -p $domain $domain/sources $domain/sources/dnsprobe $domain/Recon $domain/Recon/sub_takeover $domain/Recon/nuclei $domain/Recon/wayback $domain/Recon/gf $domain/Recon/wordlist $domain/Recon/masscan
